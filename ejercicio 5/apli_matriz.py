    ...
    while op != "s" and op != "S":
        ...
        if op == "a" or op == "A":
            ...
            if vali:
                ...
                #matrizA.Print_m()
                imprimir_matrizA = Thread(target=matrizA.Print_m)
                imprimir_matrizA.start()
                imprimir_matrizA.join()
            ...
            print("Matriz A")
            matrizA.Crear_m()
            llenar_matrizA = Thread(target=matrizA.Llenar_m)
            llenar_matrizA.start()
            llenar_matrizA.join()
            ...
            print("matriz Generada")
            matrizA.Print_m()
            num = int(input('Ingrese número por el que se multiplicara la matriz: \n'))
            ...
            try:
                ...
                print("No se pudo hallar la potencia de la matriz")
        elif op == "f" or op == "F":
            matrizA = matriz.Matriz()
            matrizA.Crear_m()
            matrizA.Llenar_manual()
